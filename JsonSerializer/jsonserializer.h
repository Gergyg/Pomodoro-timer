...
void JSONSERIALIZER_EXPORT serializeStats(vector<map<string, map<string, int>>>, string file_name);
...
vector<map<string, map<string, int>>> JSONSERIALIZER_EXPORT deserializeStats(string file_name);
